...
TimeSinceLastTypedUrlEvent::
    TimeSinceLastTypedUrlEvent() = default;

TimeSinceLastTypedUrlEvent::
    ~TimeSinceLastTypedUrlEvent() = default;

mojom::DataType TimeSinceLastTypedUrlEvent::GetDataType()
    const {
  return mojom::DataType::kInt;
}

mojom::CovariateType
TimeSinceLastTypedUrlEvent::GetCovariateType() const {
  return mojom::CovariateType::kTimeSinceLastPlayedMediaEvent;
}

std::string TimeSinceLastTypedUrlEvent::GetValue() const {
