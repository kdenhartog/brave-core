...
TimeSinceLastClosedTabEvent::
    TimeSinceLastClosedTabEvent() = default;

TimeSinceLastClosedTabEvent::
    ~TimeSinceLastClosedTabEvent() = default;

mojom::DataType TimeSinceLastClosedTabEvent::GetDataType()
    const {
  return mojom::DataType::kInt;
}

mojom::CovariateType
TimeSinceLastClosedTabEvent::GetCovariateType() const {
  return mojom::CovariateType::kTimeSinceLastClosedTabEvent;
}

std::string TimeSinceLastClosedTabEvent::GetValue() const {
