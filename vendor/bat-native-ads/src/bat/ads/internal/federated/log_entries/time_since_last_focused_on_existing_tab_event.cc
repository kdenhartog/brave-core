...
TimeSinceLastFocusedOnExistingTabEvent::
    TimeSinceLastFocusedOnExistingTabEvent() = default;

TimeSinceLastFocusedOnExistingTabEvent::
    ~TimeSinceLastFocusedOnExistingTabEvent() = default;

mojom::DataType TimeSinceLastFocusedOnExistingTabEvent::GetDataType()
    const {
  return mojom::DataType::kInt;
}

mojom::CovariateType
TimeSinceLastFocusedOnExistingTabEvent::GetCovariateType() const {
  return mojom::CovariateType::kTimeSinceLastFocusedOnExistingTabEvent;
}

std::string TimeSinceLastFocusedOnExistingTabEvent::GetValue() const {
