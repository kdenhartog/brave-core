...
TimeSinceLastPlayedMediaEvent::
    TimeSinceLastPlayedMediaEvent() = default;

TimeSinceLastPlayedMediaEvent::
    ~TimeSinceLastPlayedMediaEvent() = default;

mojom::DataType TimeSinceLastPlayedMediaEvent::GetDataType()
    const {
  return mojom::DataType::kInt;
}

mojom::CovariateType
TimeSinceLastPlayedMediaEvent::GetCovariateType() const {
  return mojom::CovariateType::kTimeSinceLastPlayedMediaEvent;
}

std::string TimeSinceLastPlayedMediaEvent::GetValue() const {
