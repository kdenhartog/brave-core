...
TimeSinceLastSubmittedFormEvent::
    TimeSinceLastSubmittedFormEvent() = default;

TimeSinceLastSubmittedFormEvent::
    ~TimeSinceLastSubmittedFormEvent() = default;

mojom::DataType TimeSinceLastSubmittedFormEvent::GetDataType()
    const {
  return mojom::DataType::kInt;
}

mojom::CovariateType
TimeSinceLastSubmittedFormEvent::GetCovariateType() const {
  return mojom::CovariateType::kTimeSinceLastPlayedMediaEvent;
}

std::string TimeSinceLastSubmittedFormEvent::GetValue() const {
